...
namespace CategoryProductConsoleApp
{
    partial class Program
    {
        ...
        public static void Init()
        {
            ...
            Panels.ShowHeader("Demo", 
                "This application will create a new database defined by [cyan]EF Core[/] " + 
                "models with the [b]database[/] name in [b]appsettings.json[/]. You will be prompted to " + 
                "enter how many records to create then used to create Products followed by displaying the data.");
        }
